...
func NewPublisher(cfg Config) Publisher {
	if !cfg.Enabled {
		log.Println("[Inventario][Kafka] Publicacion deshabilitada")
		return NoopPublisher{}
	}

	if cfg.BootstrapServers == "" || cfg.Topic == "" {
		log.Println("[Inventario][Kafka] Configuracion incompleta; publicacion deshabilitada")
		return NoopPublisher{}
	}
...
func (p *KafkaPublisher) Enabled() bool {
	return p.enabled
}
